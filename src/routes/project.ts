...
import { create , get , destroy , update , addTaskToProject , getTaskOfProject , updateTaskOfProject , destroyTaskOfProject } from '../controller/ProjectController';
...
routes.delete('/delete-task/:id',[
    param('id','Id is not valid').isString(),
    body('taskId','taskId is a required filed')
    .isString(),
    checkValidate,
],destroyTaskOfProject);
